...
if __name__ == '__main__':
    print("load params from : ", args.digitsum_with_params_path_box)
    params = json.load(open(args.digitsum_with_params_path_box, 'r', encoding="utf-8"))
    global ITERATION
    ITERATION=params['ITERATION']
    assert params is not None
    res=main(params=params)
    json.dump(res,open(args.digitsum_out_box,"w+",encoding="utf-8"),ensure_ascii=False)
