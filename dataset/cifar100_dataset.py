...
from common.cmd_args import CIFAR100_PATH
...
def get_CIFAR100_train_and_val_loader(args):
    ...
    trainset = CIFAR100WithIdx(root=CIFAR100_PATH,
                               train=True,
                               download=True,#True
                               transform=transform_train,
                               rand_fraction=args.rand_fraction,
                               seed=args.seed)
    valset = CIFAR100WithIdx(root=CIFAR100_PATH,
                             train=False,
                             download=True,#True
...
def get_CIFAR100_model_and_loss_criterion(args, params=None, ITERATION=None):
