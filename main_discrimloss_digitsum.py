...
def main_worker(args, config):
    ...
    # Create model
    model, loss_criterion, loss_criterion_val, logname = mdl_loss(args, params={"tanh_a": 0.33968912524349415,
                                                                                "tanh_p": 4.450234246672018,
                                                                                "tanh_q": -31.0, })
    ...
    # optimizer=torch.optim.RMSprop(model.parameters(), lr=args.lr, alpha=0.99, eps=1e-08, weight_decay=0.0, momentum=0, centered=False)
...
def main():
    ...
    config['clamp_inst_sigma']['min'] = 0.19371991143231937
