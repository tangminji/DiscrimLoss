...
def main_worker(args, config, params, ITERATION):
    ...
    # Create model
    model, loss_criterion, loss_criterion_val, logname = cifar10_dataset.get_CIFAR10_model_and_loss_criterion(args,
                                                                                                              params,
                                                                                                              ITERATION)
    ...
    train_loader, val_loader = cifar10_dataset.get_CIFAR10_train_and_val_loader(args)
...
if __name__ == '__main__':
    ...
    MAX_EVALS = 3
    space = {
        'lr_inst_param': hp.loguniform('lr_inst_param', np.log(5e-4), np.log(5e-3)),
        ...
        # 'tanh_a': hp.uniform('tanh_a', 0.1, 15),
